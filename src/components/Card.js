    ...
    return (
        <div class = "card-wrapper mr-5 mx-auto">
            ...
            <div class = "task-holder">
                ...
                <p className = "mt-3">{taskObj.contact}</p>

                <div style={{"position": "absolute", "right" : "20px", "bottom" : "20px"}}>
                    {/* <i class = "far fa-edit mr-3" style={{"color" : colors[index%5].primaryColor, "cursor" : "pointer"}} onClick = {() => setModal(true)}></i> */}
                    <i class="fas" style = {{"color" : colors[index%5].primaryColor, "cursor" : "pointer"}} onClick = {handleDelete}><button>Collect Food</button></i>
                </div>
        </div>
